...
void CreateCloneTempKahmlsteinFakeout(int entity, int TypeOfFake, float SelfPos[3], float AllyAng[3])
{
	...
	switch(TypeOfFake)
	{
		case 2:
		{
			KamlcloneSpawn = NPC_CreateByName("npc_chaos_kahmlstein", -1, SelfPos, AllyAng, GetTeam(entity), "fake_2"); //can only be enemy
		}
		case 3:
		{
			KamlcloneSpawn = NPC_CreateByName("npc_chaos_kahmlstein", -1, SelfPos, AllyAng, GetTeam(entity), "fake_3"); //can only be enemy
		}
		case 4:
		{
			KamlcloneSpawn = NPC_CreateByName("npc_chaos_kahmlstein", -1, SelfPos, AllyAng, GetTeam(entity), "fake_4"); //can only be enemy
		}
	}
