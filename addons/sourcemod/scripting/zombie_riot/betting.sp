		...
		switch(GameState)
		{
			case State_Vote:
			{
				if(Voting && Voting.Length > 1)
				{
					...
					SetHudTextParams(0.15, -1.0, 0.31, 55, 55, 255, 255, 0, 0.0, 0.0, 0.0);
					ShowSyncHudText(client, SyncHud_WandMana, vote.Config);

					Voting.GetArray(1, vote);
					SetHudTextParams(0.65, -1.0, 0.31, 255, 55, 55, 255, 0, 0.0, 0.0, 0.0);
			...
			case State_Stage:
			{
				...
				SetHudTextParams(0.0, -1.0, 0.31, 55, 55, 255, 255, 0, 0.0, 0.0, 0.0);
				ShowSyncHudText(client, SyncHud_WandMana, buffer[0]);

				SetHudTextParams(1.0, -1.0, 0.31, 255, 55, 55, 255, 0, 0.0, 0.0, 0.0);
