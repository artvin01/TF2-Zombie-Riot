	...
	if(!b_ThisNpcIsSawrunner[attacker])
	{
		...
		//	bool Though_Armor = false;
			...
			if(i_CurrentEquippedPerk[victim] == 6)
			{
				...
				if((damage > float(flMaxHealth / 20) || flHealth < flMaxHealth / 5 || damage > 50.0) && f_WidowsWineDebuffPlayerCooldown[victim] < GetGameTime()) //either too much dmg, or your health is too low.
				{
