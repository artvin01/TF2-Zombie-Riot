...
static void Wand_Launch(int client, int iRot, float speed, float time, float damage, int weapon)
{
	...
	{
		case 2:
			particle = ParticleEffectAt(position, "unusual_genplasmos_b_parent", 5.0);
	...
	SDKHook(iCarrier, SDKHook_StartTouch, Event_Wand_Elemental_OnHatTouch);
}

public Action Event_Wand_Elemental_OnHatTouch(int entity, int other)
{
