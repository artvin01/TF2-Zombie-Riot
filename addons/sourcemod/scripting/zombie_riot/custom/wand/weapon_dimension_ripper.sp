...
public void Weapon_Dimension_Summon_Normal_PAP(int client, int weapon, bool &result, int slot, int pap_logic)
{
	...
	{
		case 1:
			Dimension_Summon_Npc(client, SPY_MAIN_BOSS ,weapon, 2.0, 2.0, "ghost_appearation");
		case 2:
			Dimension_Summon_Npc(client, SPY_FACESTABBER ,weapon, 1.2, 1.1, "ghost_appearation");
		case 3:
			Dimension_Summon_Npc(client, COMBINE_SOLDIER_ELITE ,weapon, 1.2, 1.25, "ghost_appearation");	
		case 4:
...
public void Weapon_Dimension_Summon_Blitz_PAP(int client, int weapon, bool &result, int slot, int pap_logic)
{
	switch(GetRandomInt(1, 4))
	{
		...
		case 4:
			Dimension_Summon_Npc(client, ALT_SCHWERTKRIEG ,weapon, 2.0, 1.75, "eyeboss_tp_player");
		default: //This should not happen
		{
			ShowSyncHudText(client,  SyncHud_Notifaction, "Summon Failed. Scream at devs");//none
		}
...
public void Weapon_Dimension_Summon_Xeno_PAP(int client, int weapon, bool &result, int slot, int pap_logic)
{
	...
	{
		case 1:
			Dimension_Summon_Npc(client, XENO_BATTLE_MEDIC_MAIN ,weapon, 1.2, 1.2, "utaunt_smoke_floor1_green");
		case 2:
			Dimension_Summon_Npc(client, XENO_SPY_MAIN_BOSS ,weapon, 2.0, 2.0, "utaunt_smoke_floor1_green");
		case 3:
...
public void Weapon_Dimension_Summon_Seaborn_PAP(int client, int weapon, bool &result, int slot, int pap_logic)
{
	...
	{
		case 1:
			Dimension_Summon_Npc(client, SEABORN_KAZIMIERZ_LONGARCHER ,weapon, 1.1, 1.4, "utaunt_constellations_blue_base");
		case 2:
			Dimension_Summon_Npc(client, SEABORN_KAZIMIERZ_BESERKER ,weapon, 1.75, 1.3, "utaunt_constellations_blue_base");
		case 3:
...
public void Weapon_Dimension_Summon_Interitus_PAP(int client, int weapon, bool &result, int slot, int pap_logic)
{
	...
	{
		case 1:
			Dimension_Summon_Npc(client, INTERITUS_WINTER_SKIN_HUNTER ,weapon, 2.0, 1.8, "teleporter_blue_exit");
		case 2:
