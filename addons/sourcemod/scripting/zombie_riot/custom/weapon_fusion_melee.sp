...
void FusionWeaponEffectPap0(int owner, int client, int Wearable, char[] attachment = "effect_hand_r")
{
	...
	int Laser_1 = ConnectWithBeamClient(particle_2, particle_3, red, green, blue, 2.0, 2.0, 1.0, LASERBEAM);
	int Laser_2 = ConnectWithBeamClient(particle_3, particle_4, red, green, blue, 2.0, 2.0, 1.0, LASERBEAM);
	int Laser_3 = ConnectWithBeamClient(particle_4, particle_5, red, green, blue, 2.0, 1.0, 1.0, LASERBEAM);
...
void FusionWeaponEffectPap1(int owner, int client, int Wearable, char[] attachment = "effect_hand_r")
{
	...
	int Laser_1_1 = ConnectWithBeamClient(particle_2_1, particle_3_1, red, green, blue, 2.0, 2.0, 1.0, LASERBEAM);
	int Laser_2_1 = ConnectWithBeamClient(particle_3_1, particle_4_1, red, green, blue, 2.0, 2.0, 1.0, LASERBEAM);
	int Laser_3_1 = ConnectWithBeamClient(particle_4_1, particle_5_1, red, green, blue, 2.0, 1.0, 1.0, LASERBEAM);
...
void FusionWeaponEffectPap2(int owner, int client, int Wearable, char[] attachment = "effect_hand_r")
{
	...
	int Laser_1_l = ConnectWithBeamClient(particle_2_l, particle_4_l, red, green, blue, 2.0, 2.0, 1.0, LASERBEAM);
	int Laser_2_l = ConnectWithBeamClient(particle_3_l, particle_5_l, red, green, blue, 2.0, 2.0, 1.0, LASERBEAM);
	int Laser_3_l = ConnectWithBeamClient(particle_2_l, particle_5_l, red, green, blue, 2.0, 2.0, 1.0, LASERBEAM);
	int Laser_4_l = ConnectWithBeamClient(particle_3_l, particle_4_l, red, green, blue, 2.0, 2.0, 1.0, LASERBEAM);
	int Laser_5_l = ConnectWithBeamClient(particle_4_l, particle_5_l, red, green, blue, 1.0, 1.0, 1.0, LASERBEAM);
...
void FusionWeaponEffectPap3(int owner, int client, int Wearable, char[] attachment = "effect_hand_r")
{
	...
	int Laser_3_l = ConnectWithBeamClient(particle_2_l, particle_5_l, red, green, blue, 2.0, 2.0, 1.0, LASERBEAM);
	int Laser_4_l = ConnectWithBeamClient(particle_3_l, particle_4_l, red, green, blue, 2.0, 2.0, 1.0, LASERBEAM);
	int Laser_5_l = ConnectWithBeamClient(particle_4_l, particle_5_l, red, green, blue, 3.0, 3.0, 1.0, LASERBEAM);
