...
static void Wand_Launch(int client, int iRot, float speed, float time, float damage, int weapon)
{
	...
	{
		case 2:
			particle = ParticleEffectAt(position, "m_brazier_flame", 5.0);
	...
	SDKHook(iCarrier, SDKHook_StartTouch, Event_Wand_Fire_OnHatTouch);
}

public Action Event_Wand_Fire_OnHatTouch(int entity, int other)
{
