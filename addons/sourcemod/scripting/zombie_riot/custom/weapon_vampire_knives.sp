...
static float Vamp_ThrowMultiplier_Normal[4] = { 2.0, 3.0, 6.75, 8.0 }; //Amount to multiply damage dealt by thrown knives.
static float Vamp_ThrowCD_Normal[4] = { 6.0, 9.0, 12.0, 12.0 }; //Knife throw cooldown.
static int Vamp_ThrowKnives_Normal[4] = { 2, 3, 3, 3 }; //Number of knives thrown by M2.
static int Vamp_ThrowWaves_Normal[4] = { 2, 2, 3, 4 }; //Number of times to throw knives with M2.
...
static float Vamp_ThrowCD_Cleaver[4] = { 10.0, 9.0, 12.0, 17.0 }; //Same as pap route 1, but for pap route 2.
static int Vamp_ThrowKnives_Cleaver[4] = { 1, 1, 2, 2 }; //Same as pap route 1, but for pap route 2.
