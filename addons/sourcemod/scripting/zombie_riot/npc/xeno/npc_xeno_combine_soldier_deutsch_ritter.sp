...
public void XenoCombineDeutsch_OnMapStart_NPC()
{
...
public void XenoCombineDeutsch_NPCDeath(int entity)
{
	XenoCombineDeutsch npc = view_as<XenoCombineDeutsch>(entity);
	if(!npc.m_bGib)
	{
		npc.PlayDeathSound();	
	}
