...
public void XenoFastZombie_OnMapStart_NPC()
{
...
methodmap XenoFastZombie < CClotBody
{
	...
	public XenoFastZombie(int client, float vecPos[3], float vecAng[3])
	{
		XenoFastZombie npc = view_as<XenoFastZombie>(CClotBody(vecPos, vecAng, "models/zombie/fast.mdl", "1.15", "200"));
...
public void XenoFastZombie_NPCDeath(int entity)
{
	XenoFastZombie npc = view_as<XenoFastZombie>(entity);
	if(!npc.m_bGib)
	{
		npc.PlayDeathSound();	
	}
