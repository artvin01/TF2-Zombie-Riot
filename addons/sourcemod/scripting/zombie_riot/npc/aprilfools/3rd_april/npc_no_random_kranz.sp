...
#define NoRandomKranz_NORMAL_MOVESPEED 330.0

static const char g_DeathSounds[][] = {
	"vo/soldier_mvm_paincrticialdeath01.mp3",
	"vo/soldier_mvm_paincrticialdeath02.mp3",
	"vo/soldier_mvm_paincrticialdeath03.mp3",
};

static const char g_HurtSounds[][] = {
	"vo/soldier_mvm_painsevere01.mp3",
	"vo/soldier_mvm_painsevere02.mp3",
	"vo/soldier_mvm_painsevere03.mp3",
	"vo/soldier_mvm_painsevere04.mp3",
	"vo/soldier_mvm_painsevere05.mp3",
	"vo/soldier_mvm_painsevere06.mp3",
	"vo/soldier_mvm_painsharp01.mp3",
	"vo/soldier_mvm_painsharp02.mp3",
	"vo/soldier_mvm_painsharp03.mp3",
	"vo/soldier_mvm_painsharp04.mp3",
	"vo/soldier_mvm_painsharp05.mp3",
	"vo/soldier_mvm_painsharp06.mp3",
	"vo/soldier_mvm_painsharp07.mp3",
	"vo/soldier_mvm_painsharp08.mp3",
};


static const char g_IdleAlertedSounds[][] = {
	"vo/soldier_mvm_taunts18.mp3",
	"vo/soldier_mvm_taunts19.mp3",
	"vo/soldier_mvm_taunts20.mp3",
	"vo/soldier_mvm_taunts21.mp3",
};
...
methodmap NoRandomKranz < CClotBody
{
	...
	public void PlayDeathSound() 
	{
		...
		EmitSoundToAll(g_DeathSounds[sound], this.index, SNDCHAN_AUTO, BOSS_ZOMBIE_SOUNDLEVEL, _, BOSS_ZOMBIE_VOLUME);
	...
	{
		NoRandomKranz npc = view_as<NoRandomKranz>(CClotBody(vecPos, vecAng, "models/player/soldier.mdl", "1.1", "40000", ally, ally, false, false, true,true)); //giant!
...
public void NoRandomKranz_NPCDeath(int entity)
{
	...
	*/
	...
	CPrintToChatAll("{darkblue}No Random Kranz V3{default}: uh oh..!");
...
int NoRandomKranzSelfDefense(NoRandomKranz npc, float gameTime, int target, float distance)
{
		...
		if(distance < (NORMAL_ENEMY_MELEE_RANGE_FLOAT_SQUARED * 3.0))
		{
			...
			if(gameTime > npc.f_NoRandomKranzMeleeCooldown)
			{
				...
				if(distance < (NORMAL_ENEMY_MELEE_RANGE_FLOAT_SQUARED * 1.35))
				{
					...
					npc.f_NoRandomKranzMeleeCooldown = gameTime + 15.0;
	...
	if(distance < (NORMAL_ENEMY_MELEE_RANGE_FLOAT_SQUARED * 20.0) || npc.b_NoRandomKranzRocketJump)
	{
		...
		if((distance < (NORMAL_ENEMY_MELEE_RANGE_FLOAT_SQUARED * 10.0) || npc.b_NoRandomKranzRocketJump) && gameTime > npc.m_flNextRangedAttack)
		{	
			if(Can_I_See_Enemy_Only(npc.index, target))
			{
