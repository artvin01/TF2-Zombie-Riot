...
methodmap HeavyGiant < CClotBody
{
	...
	public HeavyGiant(int client, float vecPos[3], float vecAng[3])
	{
		HeavyGiant npc = view_as<HeavyGiant>(CClotBody(vecPos, vecAng, "models/player/heavy.mdl", "1.5", "15000", false, false, true));
