...
public void FortifiedPoisonZombie_OnMapStart_NPC()
{
...
methodmap FortifiedPoisonZombie < CClotBody
{
	...
	public FortifiedPoisonZombie(int client, float vecPos[3], float vecAng[3])
	{
		FortifiedPoisonZombie npc = view_as<FortifiedPoisonZombie>(CClotBody(vecPos, vecAng, "models/zombie/poison.mdl", "1.15", "1250"));
...
public Action FortifiedPoisonZombie_OnTakeDamage(int victim, int &attacker, int &inflictor, float &damage, int &damagetype, int &weapon, float damageForce[3], float damagePosition[3], int damagecustom)
{
...
public void FortifiedPoisonZombie_NPCDeath(int entity)
{
