...
methodmap Astriana < RuinaBaseNpc
{
	...
	{
		Astriana npc = view_as<Astriana>(CClotBody(vecPos, vecAng, "models/player/engineer.mdl", "1.35", "1250", ally, _,true));
		...
		*/
		...
		npc.m_iWeapon 	 = npc.EquipItem("head", Items[5], _, npc.GetSkin());

		RuinaBaseNpc(npc.m_iWeapon).m_nBody = RUINA_RADAR_GUN_1;
