...
{
	return Dronian(vecPos, vecAng, team);
}

methodmap Dronian < RuinaBaseNpc
{
	...
	public Dronian(float vecPos[3], float vecAng[3], int ally)
	{
		...
		*/
		...
		RuinaBaseNpc(npc.m_iWeapon).m_nBody = RUINA_DAGGER_1;
