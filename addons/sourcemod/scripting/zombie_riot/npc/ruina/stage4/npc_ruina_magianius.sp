...
void Magianius_OnMapStart_NPC()
{
	...
	strcopy(data.Icon, sizeof(data.Icon), "soldier_crit"); 						//leaderboard_class_(insert the name)
...
{
	return Magianius(client, vecPos, vecAng, ally);
}
...
methodmap Magianius < CClotBody
{
	...
	public Magianius(int client, float vecPos[3], float vecAng[3], int ally)
	{
