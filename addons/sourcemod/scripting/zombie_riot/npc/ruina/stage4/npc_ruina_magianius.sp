...
methodmap Magianius < CClotBody
{
	...
	public Magianius(float vecPos[3], float vecAng[3], int ally)
	{
		...
		/*
			...
			"Vestan Villainy"		"models/workshop/player/items/medic/hwn2022_vestan_villainy_style3/hwn2022_vestan_villainy_style3.mdl"
		...
		*/
		static const char Items[][] = {
			...
			"models/workshop/player/items/medic/hwn2022_vestan_villainy_style3/hwn2022_vestan_villainy_style3.mdl",
