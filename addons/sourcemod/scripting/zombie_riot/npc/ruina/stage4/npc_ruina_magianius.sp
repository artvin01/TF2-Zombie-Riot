...
void Magianius_OnMapStart_NPC()
{
	...
	NPCData data;
	strcopy(data.Name, sizeof(data.Name), "Magianius");
	strcopy(data.Plugin, sizeof(data.Plugin), "npc_ruina_magianius");
...
{
	return Magianius(vecPos, vecAng, team);
}

static float fl_npc_basespeed;

methodmap Magianius < CClotBody
{
	...
	public Magianius(float vecPos[3], float vecAng[3], int ally)
	{
		Magianius npc = view_as<Magianius>(CClotBody(vecPos, vecAng, "models/player/medic.mdl", "1.0", "1250", ally));
		...
		/*
			...
			"Victorian Villainy"		"models/workshop/player/items/medic/hwn2022_vestian_villainy_style3/hwn2022_vestian_villainy_style3.mdl"
		...
		*/
		static const char Items[][] = {
			...
			"models/workshop/player/items/medic/hwn2022_vestian_villainy_style3/hwn2022_vestian_villainy_style3.mdl",
...
{
	Magianius npc = view_as<Magianius>(iNPC);
...
{
	Magianius npc = view_as<Magianius>(victim);
...
{
	Magianius npc = view_as<Magianius>(entity);
	if(!npc.m_bGib)
	{
		npc.PlayDeathSound();	
	}
