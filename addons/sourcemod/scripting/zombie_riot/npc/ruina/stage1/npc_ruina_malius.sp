...
methodmap Malius < RuinaBaseNpc
{
	...
	public Malius(float vecPos[3], float vecAng[3], int ally)
	{
		...
		*/
		...
		npc.m_iWeapon = npc.EquipItem("head", "models/weapons/c_models/c_builder/c_builder.mdl");
		SetVariantString("1.0");
		...
		int skin = npc.GetSkin(npc.index);	//1=blue, 0=red
		npc.m_nSkin = skin;
