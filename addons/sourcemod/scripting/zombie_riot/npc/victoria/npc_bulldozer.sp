...
methodmap Bulldozer < CClotBody
{
	...
	public Bulldozer(int client, float vecPos[3], float vecAng[3], int ally)
	{
		...
		*/
		...
		npc.m_iWearable2 = npc.EquipItem("head", "models/workshop/player/items/demo/hwn2023_stunt_suit_style2/hwn2023_stunt_suit_style2.mdl.mdl");
		SetVariantString("1.0");
...
public void Bulldozer_ClotThink(int iNPC)
{
	...
	GrantEntityArmor(iNPC, true, 0.5, 0.75, 0);
