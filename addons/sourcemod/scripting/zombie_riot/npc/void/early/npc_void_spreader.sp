...
public void VoidSpreader_ClotThink(int iNPC)
{
	...
	if(IsValidEnemy(npc.index, npc.m_iTarget))
	{
		...
		VoidSpreaderSelfDefense(npc,GetGameTime(npc.index), npc.m_iTarget, flDistanceToTarget); 
	}
	else
	{
		npc.m_flGetClosestTargetTime = 0.0;
...
void VoidSpreaderSelfDefense(VoidSpreader npc, float gameTime, int target, float distance)
{
