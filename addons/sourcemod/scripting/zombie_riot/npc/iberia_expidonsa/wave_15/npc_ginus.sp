...
{
	return IberiaGinus(client, vecPos, vecAng, ally);
}
methodmap IberiaGinus < CClotBody
{
	...
	public IberiaGinus(int client, float vecPos[3], float vecAng[3], int ally)
	{
		...
		npc.m_iWearable1 = npc.EquipItem("head", "models/workshop/player/items/soldier/short2014_soldier_fed_coat/short2014_soldier_fed_coat.mdl");

		npc.m_iWearable2 = npc.EquipItem("head", "models/workshop/player/items/soldier/sum22_detective/sum22_detective.mdl");
