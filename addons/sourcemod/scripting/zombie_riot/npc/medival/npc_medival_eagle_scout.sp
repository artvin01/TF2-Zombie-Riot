...
methodmap MedivalEagleScout < CClotBody
{
	...
	{
		MedivalEagleScout npc = view_as<MedivalEagleScout>(CClotBody(vecPos, vecAng, COMBINE_CUSTOM_MODEL, "1.15", "1000", ally));
...
//		SetEntityRenderColor(npc.index, 200, 255, 200, 255);
		...
		npc.m_flMeleeArmor = 1.15; //They take MORE melee damage.
