...
methodmap SandvichSlayer < CClotBody
{
	...
	{
		SandvichSlayer npc = view_as<SandvichSlayer>(CClotBody(vecPos, vecAng, "models/player/heavy.mdl", "1.5", "15000", ally, false, true));
...
public void SandvichSlayer_ClotThink(int iNPC)
{
	...
	if(!b_IsAlliedNpc[npc.index])
	{
		if(ExecuteCustomPootisTheme <= GetGameTime(npc.index) && OnePootisDied && DisableMainPootisTheme && MainLeaderDied)
		{
