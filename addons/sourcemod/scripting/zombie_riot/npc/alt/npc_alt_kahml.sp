...
static void Kahmlstein_Talk(int iNPC, const char[] message)
{
...
static void Internal_ClotThink(int iNPC)
{
	...
	if(IsValidEnemy(npc.index, PrimaryThreatIndex))
	{
		...
		{	//necksnap
			...
			Kahmlstein_Talk(npc.index, "{crimson}I Will BREAK YOU");
		...
		{
			Kahmlstein_Talk(npc.index, "I don't have time for this.");
		...
		if(fl_kahml_nano_reset[npc.index] <= GameTime && b_kahml_inNANOMACHINESSON[npc.index])
		{
			...
			Kahmlstein_Talk(npc.index, "You Lived, Good work.");
...
static void Internal_NPCDeath(int entity)
{
	...
	Kahmlstein_Talk(npc.index, "You're boring me, im leaving.");
