...
static void DonnerNormAttack(Donnerkrieg npc)
{
	...
	Data.Close_Dps = 200.0 / 6.0 / TickrateModify / f_AttackSpeedNpcIncrease[npc.index];
	Data.Long_Dps = 100.0 / 6.0 / TickrateModify / f_AttackSpeedNpcIncrease[npc.index];
...
public Action NightmareCannon_TBB_Tick(int client)
{
	...
	Data.Range = -1.0;
	//divided by 6 since its every tick, and by TickrateModify
	Data.Close_Dps = 750.0 / 6.0 / TickrateModify / f_AttackSpeedNpcIncrease[npc.index];
	Data.Long_Dps = 450.0 / 6.0 / TickrateModify / f_AttackSpeedNpcIncrease[npc.index];
