...
void Mecha_Heavy_OnMapStart_NPC()
{
	...
	NPCData data;
	strcopy(data.Name, sizeof(data.Name), "Mecha Heavy");
	strcopy(data.Plugin, sizeof(data.Plugin), "npc_alt_mecha_heavy");
...
{
	return Mecha_Heavy(client, vecPos, vecAng, ally, data);
}
