...
static const char g_IdleSounds[][] = {
	"vo/mvm/norm/engineer_mvm_standonthepoint01.mp3",
	"vo/mvm/norm/engineer_mvm_standonthepoint02.mp3",
};
...
void Mecha_Engineer_OnMapStart_NPC()
{
...
methodmap Mecha_Engineer < CClotBody
{
	...
	public Mecha_Engineer(int client, float vecPos[3], float vecAng[3], bool ally)
	{
...
//TODO 
//Rewrite
public void Mecha_Engineer_ClotThink(int iNPC)
{
...
public void Mecha_Engineer_NPCDeath(int entity)
{
	Mecha_Engineer npc = view_as<Mecha_Engineer>(entity);
	if(!npc.m_bGib)
	{
		npc.PlayDeathSound();	
	}
