...
static Action Superrior_Mage_LaserTick(int client)
{
	...
	Data.Close_Dps = (npc.Anger ? 30.0 : 20.0) / 6.0 / TickrateModify / f_AttackSpeedNpcIncrease[npc.index];
	Data.Long_Dps = (npc.Anger ? 17.5: 10.0) / 6.0 / TickrateModify / f_AttackSpeedNpcIncrease[npc.index];
