...
void AlminaMurdarato_OnMapStart_NPC()
{
	...
	NPCData data;
	strcopy(data.Name, sizeof(data.Name), "Murdarato");
	strcopy(data.Plugin, sizeof(data.Plugin), "npc_murdarato");
...
methodmap AlminaMurdarato < CClotBody
{
	...
	public AlminaMurdarato(float vecPos[3], float vecAng[3], int ally)
	{
		...
		npc.m_iWearable2 = npc.EquipItem("head", "models/workshop/player/items/scout/sum24_commonwealth/sum24_commonwealth.mdl");
		npc.m_iWearable3 = npc.EquipItem("head", "models/workshop/player/items/all_class/dec23_cozy_coverup_style3/dec23_cozy_coverup_style3_medic.mdl");
