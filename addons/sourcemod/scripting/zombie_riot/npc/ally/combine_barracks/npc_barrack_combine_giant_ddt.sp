...
methodmap Barrack_Combine_Giant_Ddt < BarrackBody
{
	...
	public void PlayMeleeMissSound() {
		EmitSoundToAll(g_MeleeMissSounds[GetRandomInt(0, sizeof(g_MeleeMissSounds) - 1)], this.index, SNDCHAN_VOICE, NORMAL_ZOMBIE_SOUNDLEVEL, _, NORMAL_ZOMBIE_VOLUME, 100);
	...
	{
		Barrack_Combine_Giant_Ddt npc = view_as<Barrack_Combine_Giant_Ddt>(BarrackBody(client, vecPos, vecAng, "1250", COMBINE_CUSTOM_MODEL, STEPTYPE_COMBINE,"0.7",_,"models/pickups/pickup_powerup_strength_arm.mdl"));
...
public void Barrack_Combine_Giant_Ddt_ClotThink(int iNPC)
{
	...
	if(BarrackBody_ThinkStart(npc.index, GameTime))
	{
		...
		BarrackBody_ThinkMove(npc.index, 270.0, "ACT_IDLE", "ACT_WALK");
	}
}
