static const char NPCModel[] = "models/zombie_riot/cof/sawrunner_1.mdl";

void Addicition_OnMapStart()
{
...
methodmap Addicition < CClotBody
{
	...
	{
		Addicition npc = view_as<Addicition>(CClotBody(vecPos, vecAng, buffer, "1.5", "300", ally, false, true));
		i_NpcInternalId[npc.index] = ADDICTION;
