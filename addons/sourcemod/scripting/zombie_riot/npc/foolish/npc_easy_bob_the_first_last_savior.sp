...
void EasyBobTheFirst_OnMapStart()
{
	NPCData data;
	strcopy(data.Name, sizeof(data.Name), "?????????????");
	strcopy(data.Plugin, sizeof(data.Plugin), "npc_easy_bob_the_first_last_savior");
...
{
	return EasyBobTheFirst(vecPos, vecAng, team, data);
}

methodmap EasyBobTheFirst < CClotBody
{
	...
	public EasyBobTheFirst(float vecPos[3], float vecAng[3], int ally, const char[] data)
	{
		float pos[3];
		pos = vecPos;
		...
		EasyBobTheFirst npc = view_as<EasyBobTheFirst>(CClotBody(pos, vecAng, COMBINE_CUSTOM_MODEL, "1.15", "20000000", ally, _, _, true, false));
		...
		func_NPCDeath[npc.index] = EasyBobTheFirst_NPCDeath;
		func_NPCOnTakeDamage[npc.index] = EasyBobTheFirst_OnTakeDamage;
		func_NPCThink[npc.index] = EasyBobTheFirst_ClotThink;
...
public void EasyBobTheFirst_ClotThink(int iNPC)
{
	EasyBobTheFirst npc = view_as<EasyBobTheFirst>(iNPC);
	...
	if(npc.m_bFakeClone)
	{
		for(int i; i < i_MaxcountNpcTotal; i++)
		{
			...
			if(other != INVALID_ENT_REFERENCE && other != npc.index)
			{
				...
				{
					if(!view_as<EasyBobTheFirst>(other).m_bFakeClone && IsEntityAlive(other) && GetTeam(other) == GetTeam(npc.index))
					{
						if(view_as<EasyBobTheFirst>(other).Anger)
						{
...
{
	AddEasyBobEnemy(entity, "npc_combine_soldier_elite", "First Elite", RoundToCeil(2.5 * MultiGlobalEnemy), 1250);
	AddEasyBobEnemy(entity, "npc_combine_soldier_swordsman_ddt", "First DDT", RoundToCeil(2.5 * MultiGlobalEnemy), 1250);
	AddEasyBobEnemy(entity, "npc_combine_soldier_swordsman", "First Swordsman", RoundToCeil(3.7 * MultiGlobalEnemy), 1500);
	AddEasyBobEnemy(entity, "npc_combine_soldier_giant_swordsman", "First Giant Swordsman", RoundToCeil(1.7 * MultiGlobalEnemy), 5000);
	AddEasyBobEnemy(entity, "npc_combine_soldier_collos_swordsman", "First Golden Collos", RoundToCeil(1.0 * MultiGlobalEnemy), RoundToCeil(10000.0 * MultiGlobalHighHealthBoss),1 );

	AddEasyBobEnemy(entity, "npc_combine_soldier_swordsman_ddt", "First DDT", RoundToCeil(2.5 * MultiGlobalEnemy), 1250);
	AddEasyBobEnemy(entity, "npc_combine_soldier_elite", "First Elite", RoundToCeil(2.5 * MultiGlobalEnemy), 1250);
	AddEasyBobEnemy(entity, "npc_combine_soldier_giant_swordsman", "First Giant Swordsman", RoundToCeil(2.5 * MultiGlobalEnemy), 5000);

	AddEasyBobEnemy(entity, "npc_combine_soldier_swordsman", "First Swordsman", RoundToCeil(3.7 * MultiGlobalEnemy), 1500);
	AddEasyBobEnemy(entity, "npc_combine_soldier_swordsman_ddt", "First DDT", RoundToCeil(1.7 * MultiGlobalEnemy), 1250);
	AddEasyBobEnemy(entity, "npc_combine_soldier_giant_swordsman", "First Giant Swordsman", RoundToCeil(2.5 * MultiGlobalEnemy), 5000);

	AddEasyBobEnemy(entity, "npc_combine_soldier_elite", "First Elite", RoundToCeil(2.5 * MultiGlobalEnemy), 1250);
	AddEasyBobEnemy(entity, "npc_combine_soldier_swordsman_ddt", "First DDT", RoundToCeil(2.5 * MultiGlobalEnemy), 1250);
	AddEasyBobEnemy(entity, "npc_combine_soldier_shotgun", "First Shotgunner", RoundToCeil(2.5 * MultiGlobalEnemy), 1000);

	AddEasyBobEnemy(entity, "npc_combine_soldier_elite", "First Elite", RoundToCeil(1.2 * MultiGlobalEnemy), 1250);
	AddEasyBobEnemy(entity, "npc_combine_soldier_swordsman_ddt", "First DDT", RoundToCeil(1.2 * MultiGlobalEnemy), 1250);
	AddEasyBobEnemy(entity, "npc_combine_soldier_ar2", "First Rifler", RoundToCeil(1.2 * MultiGlobalEnemy), 1100);
	AddEasyBobEnemy(entity, "npc_combine_soldier_swordsman", "First Swordsman", RoundToCeil(1.2 * MultiGlobalEnemy), 1500);
	AddEasyBobEnemy(entity, "npc_combine_soldier_giant_swordsman", "First Giant Swordsman", RoundToCeil(1.2 * MultiGlobalEnemy), 5000);
	AddEasyBobEnemy(entity, "npc_combine_soldier_shotgun", "First Shotgunner", RoundToCeil(1.2 * MultiGlobalEnemy), 1000);
	AddEasyBobEnemy(entity, "npc_combine_soldier_ar2", "First Rifler", RoundToCeil(1.2 * MultiGlobalEnemy), 1100);
	AddEasyBobEnemy(entity, "npc_combine_police_smg", _, RoundToCeil(1.2 * MultiGlobalEnemy), 700);
	AddEasyBobEnemy(entity, "npc_combine_police_pistol", _, RoundToCeil(1.2 * MultiGlobalEnemy), 550);
}

static void AddEasyBobEnemy(int bobindx, const char[] plugin, const char[] name = "", int count, int health = 0, int boss = 0)
{
	Enemy enemy;
...
Action EasyBobTheFirst_OnTakeDamage(int victim, int &attacker, int &inflictor, float &damage, int &damagetype, int &weapon, float damageForce[3], float damagePosition[3], int damagecustom)
{
	//Valid attackers only.
	if(attacker < 1)
		return Plugin_Continue;

	EasyBobTheFirst npc = view_as<EasyBobTheFirst>(victim);
...
void EasyBobTheFirst_NPCDeath(int entity)
{
	EasyBobTheFirst npc = view_as<EasyBobTheFirst>(entity);
