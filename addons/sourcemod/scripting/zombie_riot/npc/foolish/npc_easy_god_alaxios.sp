...
public void EasyAlaxios_OnMapStart()
{
	NPCData data;
	strcopy(data.Name, sizeof(data.Name), "God Alaxios");
	strcopy(data.Plugin, sizeof(data.Plugin), "npc_easy_god_alaxios");
...
{
	return EasyAlaxios(vecPos, vecAng, team, data);
}

methodmap EasyAlaxios < CClotBody
{
	...
	public EasyAlaxios(float vecPos[3], float vecAng[3], int ally, const char[] data)
	{
		EasyAlaxios npc = view_as<EasyAlaxios>(CClotBody(vecPos, vecAng, COMBINE_CUSTOM_MODEL, "1.25", "25000", ally, false, false, true,true)); //giant!
		...
		func_NPCThink[npc.index] = EasyAlaxios_ClotThink;
		
		SDKHook(npc.index, SDKHook_OnTakeDamagePost, EasyAlaxios_OnTakeDamagePost);
...
static void EasyAlaxios_ClotThink(int iNPC)
{
...
static void EasyAlaxios_OnTakeDamagePost(int victim, int attacker, int inflictor, float damage, int damagetype) 
{
	...
	if(i_RaidGrantExtra[npc.index] <= 2)
	{
		if(Ratio <= 0.85 && npc.g_TimesSummoned < 1)
		{
			...
			npc.PlaySummonSound();
			//BOOKMARK TODO
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_man_at_arms",_, RoundToCeil(3.0 * MultiGlobalEnemy));
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_archer",_, RoundToCeil(3.0 * MultiGlobalEnemy));
		}
		else if(Ratio <= 0.55 && npc.g_TimesSummoned < 2)
		{
			...
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_skirmisher",_, RoundToCeil(3.0 * MultiGlobalEnemy));
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_archer",_, RoundToCeil(2.5 * MultiGlobalEnemy));
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_eagle_scout",_, RoundToCeil(2.0 * MultiGlobalEnemy));
		}
		else if(Ratio <= 0.35 && npc.g_TimesSummoned < 3)
		{
			...
			npc.PlaySummonSound();
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_skirmisher",_, RoundToCeil(3.0 * MultiGlobalEnemy));
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_spearmen",_, RoundToCeil(2.5 * MultiGlobalEnemy));
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_man_at_arms",_, RoundToCeil(2.5 * MultiGlobalEnemy));
		}
		else if(Ratio <= 0.20 && npc.g_TimesSummoned < 4)
		{
			...
			npc.m_flDoingSpecial = GetGameTime(npc.index) + 10.0;
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_spearmen",_, RoundToCeil(2.5 * MultiGlobalEnemy));
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_scout",_, RoundToCeil(2.5 * MultiGlobalEnemy));
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_man_at_arms",_, RoundToCeil(4.0 * MultiGlobalEnemy));
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_construct", RoundToCeil(5000.0 * MultiGlobalHighHealthBoss), 1, true);		
		}
	}
	else if(i_RaidGrantExtra[npc.index] == 3)
	{
		if(Ratio <= 0.85 && npc.g_TimesSummoned < 1)
		{
			...
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_swordsman",_, RoundToCeil(3.0 * MultiGlobalEnemy));
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_eagle_warrior",_, RoundToCeil(2.0 * MultiGlobalEnemy));
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_crossbow",_, RoundToCeil(2.0 * MultiGlobalEnemy));
		}
		else if(Ratio <= 0.55 && npc.g_TimesSummoned < 2)
		{
			npc.g_TimesSummoned = 2;
			...
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_light_cav",_, RoundToCeil(2.0 * MultiGlobalEnemy));
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_swordsman",_, RoundToCeil(6.0 * MultiGlobalEnemy));
		}
		else if(Ratio <= 0.35 && npc.g_TimesSummoned < 3)
		{
			npc.g_TimesSummoned = 3;
			...
			npc.PlaySummonSound();
			npc.m_flDoingSpecial = GetGameTime(npc.index) + 10.0;
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_brawler",_, RoundToCeil(3.0 * MultiGlobalEnemy));
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_light_cav",_, RoundToCeil(2.5 * MultiGlobalEnemy));
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_swordsman",_, RoundToCeil(2.5 * MultiGlobalEnemy));
		}
		else if(Ratio <= 0.20 && npc.g_TimesSummoned < 4)
		{
			SetEntProp(npc.index, Prop_Data, "m_iHealth", ReturnEntityMaxHealth(npc.index) / 4);
			...
			npc.PlaySummonSound();
			npc.m_flDoingSpecial = GetGameTime(npc.index) + 10.0;
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_pikeman",_, RoundToCeil(7.0 * MultiGlobalEnemy));
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_crossbow_giant",_, RoundToCeil(1.0 * MultiGlobalEnemy));
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_monk",RoundToCeil(5000.0 * MultiGlobalHighHealthBoss), 1, true);		
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_construct", RoundToCeil(5000.0 * MultiGlobalHealthBoss), RoundToCeil(1.0 * MultiGlobalEnemyBoss), true);				
		}
	}
	else if(i_RaidGrantExtra[npc.index] == 4)
	{
		if(Ratio <= 0.85 && npc.g_TimesSummoned < 1)
		{
			...
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_twohanded_swordsman",_, RoundToCeil(3.0 * MultiGlobalEnemy));
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_eagle_warrior",_, RoundToCeil(6.0 * MultiGlobalEnemy));
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_longbowmen",_, RoundToCeil(2.0 * MultiGlobalEnemy));
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_knight",_, RoundToCeil(2.5 * MultiGlobalEnemy));
		}
		else if(Ratio <= 0.55 && npc.g_TimesSummoned < 2)
		{
			npc.g_TimesSummoned = 2;
			...
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_knight",_, RoundToCeil(2.5 * MultiGlobalEnemy));
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_twohanded_swordsman",_, RoundToCeil(6.0 * MultiGlobalEnemy));
		}
		else if(Ratio <= 0.35 && npc.g_TimesSummoned < 3)
		{
			npc.g_TimesSummoned = 3;
			...
			npc.PlaySummonSound();
			npc.m_flDoingSpecial = GetGameTime(npc.index) + 10.0;
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_elite_skirmisher",_, RoundToCeil(3.0 * MultiGlobalEnemy));
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_light_cav",_, RoundToCeil(6.0 * MultiGlobalEnemy));
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_swordsman_giant",_, RoundToCeil(1.0 * MultiGlobalEnemy));
		}
		else if(Ratio <= 0.20 && npc.g_TimesSummoned < 4)
		{
			SetEntProp(npc.index, Prop_Data, "m_iHealth", ReturnEntityMaxHealth(npc.index) / 4);
			...
			npc.PlaySummonSound();
			npc.m_flDoingSpecial = GetGameTime(npc.index) + 10.0;
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_hussar",_, RoundToCeil(1.0 * MultiGlobalEnemy));
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_obuch",_, RoundToCeil(4.0 * MultiGlobalEnemy));
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_monk",RoundToCeil(1250.0 * MultiGlobalHighHealthBoss), 1, true);		
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_achilles", RoundToCeil(62500.0 * MultiGlobalHighHealthBoss), 1, true);		
		}
	}
	else
	{
		if(Ratio <= 0.85 && npc.g_TimesSummoned < 1)
		{
			...
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_champion",37500, RoundToCeil(3.0 * MultiGlobalEnemy));
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_arbalest",25000, RoundToCeil(6.0 * MultiGlobalEnemy));
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_elite_longbowmen",25000, RoundToCeil(2.0 * MultiGlobalEnemy));
		}
		else if(Ratio <= 0.55 && npc.g_TimesSummoned < 2)
		{
			npc.g_TimesSummoned = 2;
			...
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_champion",75000, RoundToCeil(6.0 * MultiGlobalEnemy));
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_samurai",75000, RoundToCeil(6.0 * MultiGlobalEnemy));
		}
		else if(Ratio <= 0.35 && npc.g_TimesSummoned < 3)
		{
			npc.g_TimesSummoned = 3;
			npc.PlaySummonSound();
			npc.m_flDoingSpecial = GetGameTime(npc.index) + 10.0;
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_elite_skirmisher",50000, RoundToCeil(5.0 * MultiGlobalEnemy));
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_paladin",100000, RoundToCeil(5.0 * MultiGlobalEnemy));
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_swordsman_giant",250000, RoundToCeil(1.0 * MultiGlobalEnemy));
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_achilles", RoundToCeil(150000.0 * MultiGlobalHighHealthBoss), 1);
		}
		else if(Ratio <= 0.20 && npc.g_TimesSummoned < 4)
		{
			SetEntProp(npc.index, Prop_Data, "m_iHealth", ReturnEntityMaxHealth(npc.index) / 4);
			...
			npc.PlaySummonSound();
			npc.m_flDoingSpecial = GetGameTime(npc.index) + 10.0;
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_hussar",100000, RoundToCeil(1.0 * MultiGlobalEnemy));
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_riddenarcher",75000, RoundToCeil(10.0 * MultiGlobalEnemy));
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_monk",RoundToCeil(25000.0 * MultiGlobalHighHealthBoss), 1);
			EasyGodAlaxiosSpawnEnemy(npc.index,"npc_medival_son_of_osiris", RoundToCeil(600000.0 * MultiGlobalHighHealthBoss), 1, true);		
		}
	}
}
void EasyGodAlaxiosSpawnEnemy(int alaxios, char[] plugin_name, int health = 0, int count, bool is_a_boss = false)
{
