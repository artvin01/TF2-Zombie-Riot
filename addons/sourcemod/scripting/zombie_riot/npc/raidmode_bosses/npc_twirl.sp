...
static void Twirl_Ruina_Weapon_Lines(Twirl npc, int client)
{
	...
	switch(i_CustomWeaponEquipLogic[weapon])
	{
		...
		case WEAPON_IRENE: switch(GetRandomInt(0,1)) 				{case 0: Format(Text_Lines, sizeof(Text_Lines), "Oh, so you know Amphi {gold}%N{snow}? Do you perchance have a picture of her...?", client); 			case 1: Format(Text_Lines, sizeof(Text_Lines), "Such an interesting weapon, say {gold}%N{snow} Where did you get that from?", client);}
