...
public Action Silvester_TBB_Tick(int client)
{
	...
	Data.Close_Dps = RaidModeScaling * 16.0 / 6.0 / TickrateModify / f_AttackSpeedNpcIncrease[npc.index];
	Data.Long_Dps = RaidModeScaling * 12.0 / 6.0 / TickrateModify / f_AttackSpeedNpcIncrease[npc.index];
