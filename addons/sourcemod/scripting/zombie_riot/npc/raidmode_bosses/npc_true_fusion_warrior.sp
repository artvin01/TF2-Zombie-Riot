...
static Action TrueFusionWarrior_TBB_Tick(int client)
{
	...
	Data.Close_Dps = RaidModeScaling * (npc.Anger ? 20.0 : 15.0) / 6.0 / TickrateModify / f_AttackSpeedNpcIncrease[npc.index];
	Data.Long_Dps = RaidModeScaling * (npc.Anger ? 18.5 : 12.0) / 6.0 / TickrateModify / f_AttackSpeedNpcIncrease[npc.index];
