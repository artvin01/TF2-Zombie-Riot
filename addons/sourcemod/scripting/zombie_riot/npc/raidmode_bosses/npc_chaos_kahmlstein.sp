		...
		switch(i_khamlCutscene[npc.index])
		{
			...
			case 10:
			{
				if(TimeLeft < 30.0)
				{
					...
					CPrintToChatAll("{darkblue}Kahmlstein{default}: ou killed my men, {crimson}YOU KILLED MY PUP{default}, BUT YOU ARE TOO SCARED OF ME?!");
				}
			}
			case 9:
			{
