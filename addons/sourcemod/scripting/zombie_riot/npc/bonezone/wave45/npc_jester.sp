...
static float BONES_MONDO_ATTACK_DELAY = 6.0;			//Delay before attacking upon spawning. Must be above 0.5 or else the cannonball doesn't show up on time.
...
{
	return;	//REMOVE THIS LINE WHEN ANIMATIONS ARE FINISHED
