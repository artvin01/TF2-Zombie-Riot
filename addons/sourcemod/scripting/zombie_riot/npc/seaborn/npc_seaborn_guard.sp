...
methodmap SeabornGuard < CClotBody
{
	...
	public SeabornGuard(int client, float vecPos[3], float vecAng[3], bool ally, const char[] data)
	{
		SeabornGuard npc = view_as<SeabornGuard>(CClotBody(vecPos, vecAng, COMBINE_CUSTOM_MODEL, "1.15", "3000", ally, false));
