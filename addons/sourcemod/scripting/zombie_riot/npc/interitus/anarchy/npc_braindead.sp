...
void AnarchyBraindead_OnMapStart_NPC()
{
...
methodmap AnarchyBraindead < CClotBody
{
	...
	public AnarchyBraindead(float vecPos[3], float vecAng[3], int ally)
	{
		...
		func_NPCDeath[npc.index] = view_as<Function>(AnarchyBraindead_NPCDeath);
		func_NPCOnTakeDamage[npc.index] = view_as<Function>(AnarchyBraindead_OnTakeDamage);
		func_NPCThink[npc.index] = view_as<Function>(AnarchyBraindead_ClotThink);
		...
		npc.m_iWearable2 = npc.EquipItem("head", "models/workshop/player/items/soldier/spr18_veterans_attire/spr18_veterans_attire.mdl");

		npc.m_iWearable3 = npc.EquipItem("head", "models/workshop/player/items/soldier/hw2013_mr_maggot/hw2013_mr_maggot.mdl");

		npc.m_iWearable4 = npc.EquipItem("head", "models/workshop/player/items/all_class/fall2013_the_cuban_coverup/fall2013_the_cuban_coverup_soldier.mdl");
...
public void AnarchyBraindead_ClotThink(int iNPC)
{
	AnarchyBraindead npc = view_as<AnarchyBraindead>(iNPC);
	...
	if(IsValidEnemy(npc.index, npc.m_iTarget))
	{
		...
		AnarchyBraindeadSelfDefense(npc,GetGameTime(npc.index)); 
	}
	else
	{
		npc.m_flGetClosestTargetTime = 0.0;
...
public Action AnarchyBraindead_OnTakeDamage(int victim, int &attacker, int &inflictor, float &damage, int &damagetype, int &weapon, float damageForce[3], float damagePosition[3], int damagecustom)
{
	AnarchyBraindead npc = view_as<AnarchyBraindead>(victim);
...
public void AnarchyBraindead_NPCDeath(int entity)
{
	AnarchyBraindead npc = view_as<AnarchyBraindead>(entity);
	if(!npc.m_bGib)
	{
		npc.PlayDeathSound();	
	}
...
void AnarchyBraindeadSelfDefense(AnarchyBraindead npc, float gameTime)
{
	int target;
