...
public void VoidCombineSoldierShotgun_OnMapStart_NPC()
{
	...
	NPCData data;
	strcopy(data.Name, sizeof(data.Name), "Voided W.F. Shotgunner");
	strcopy(data.Plugin, sizeof(data.Plugin), "npc_voided_combine_soldier_shotgun");
...
{
	return VoidCombineSoldierShotgun(client, vecPos, vecAng, ally);
}

methodmap VoidCombineSoldierShotgun < CClotBody
{
	...
	public VoidCombineSoldierShotgun(int client, float vecPos[3], float vecAng[3], int ally)
	{
		VoidCombineSoldierShotgun npc = view_as<VoidCombineSoldierShotgun>(CClotBody(vecPos, vecAng, "models/combine_soldier.mdl", "1.15", "650", ally));
		...
		func_NPCDeath[npc.index] = VoidCombineSoldierShotgun_NPCDeath;
		func_NPCOnTakeDamage[npc.index] = VoidCombineSoldierShotgun_OnTakeDamage;
		func_NPCThink[npc.index] = VoidCombineSoldierShotgun_ClotThink;
...
//TODO 
//Rewrite
public void VoidCombineSoldierShotgun_ClotThink(int iNPC)
{
	VoidCombineSoldierShotgun npc = view_as<VoidCombineSoldierShotgun>(iNPC);
...
public Action VoidCombineSoldierShotgun_OnTakeDamage(int victim, int &attacker, int &inflictor, float &damage, int &damagetype, int &weapon, float damageForce[3], float damagePosition[3], int damagecustom)
{
	//Valid attackers only.
	if(attacker <= 0)
		return Plugin_Continue;
		
	VoidCombineSoldierShotgun npc = view_as<VoidCombineSoldierShotgun>(victim);
...
public void VoidCombineSoldierShotgun_NPCDeath(int entity)
{
	VoidCombineSoldierShotgun npc = view_as<VoidCombineSoldierShotgun>(entity);
	if(!npc.m_bGib)
	{
		npc.PlayDeathSound();	
	}
