...
void DHook_Setup()
{
	...
	// https://github.com/sapphonie/tf2-edict-limiter/releases/tag/v3.0.4) Due to zr's nature of spawning lots of enemies, it can cause issues if they die way too fast, this is a fix.
